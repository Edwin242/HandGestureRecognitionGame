...
export class Player {
  ...
  applyInputs(dt) {
    if (this.controls.isLocked === true) {
      if (this.onGround) {
        // Only set horizontal velocities when on the ground
        ...
        const airControlFactor = 0.1; // Adjust as needed
        this.velocity.x += this.input.x * airControlFactor * dt;
        this.velocity.z += this.input.z * airControlFactor * dt;
      }
